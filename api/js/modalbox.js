...
function lastActionGeneral() 
{
	ajaxGETRequest("ajax_handler_student.php?mode=finishActivity", 1, displayRightContent);
	ajaxGETRequest("ajax_handler_student.php?mode=leftContent", 1, displayLeftContent);
} 
